Olá, eu sou Luiz Gustavo 👋 🙋 Sobre mim
...
Desenvolvimento de Sistemas Lógica de Programação (utilizando principalmente Python) Levantamento de Requisitos Arquitetura de Redes Sistemas Operacionais

💻 Tenho grande interesse por tecnologia, programação e inovação, buscando evoluir constantemente e ampliar minhas habilidades na área de desenvolvimento.

⚽ Sou torcedor do Santos Futebol Clube e apaixonado por futebol, um esporte que faz parte da minha vida.

🎸 Nos momentos de paz, gosto de tocar violão, uma atividade que me ajuda a relaxar, refletir e manter o equilíbrio.
